...
import org.eu.droid_ng.os.Build.NG_VERSION_CODES;
...
public final class Concierge {
    ...
    /**
     * Since there might be a case where new versions of the ng framework use applications running
     ...
     * {@link NG_VERSION_CODES}
     * @hide
     */
    public static final int PARCELABLE_VERSION = NG_VERSION_CODES.ONE;
