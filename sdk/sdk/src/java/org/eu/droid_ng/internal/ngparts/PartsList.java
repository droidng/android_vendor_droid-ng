 ...
 */
package org.eu.droid_ng.internal.ngparts;
...
import static org.eu.droid_ng.platform.R.styleable.ng_Searchable;
import static org.eu.droid_ng.platform.R.styleable.ng_Searchable_xmlRes;
...
public class PartsList {
    ...
    public static final String EXTRA_PART = ":ng:part";

    public static final String NGPARTS_PACKAGE = "org.eu.droid_ng.ngparts";

    public static final ComponentName NGPARTS_ACTIVITY = new ComponentName(
            NGPARTS_PACKAGE, NGPARTS_PACKAGE + ".PartsActivity");

    public static final String PARTS_ACTION_PREFIX = NGPARTS_PACKAGE + ".parts";
    ...
    private void loadParts() {
        synchronized (mParts) {
            ...
            try {
                final Resources r = pm.getResourcesForApplication(NGPARTS_PACKAGE);
                if (r == null) {
                    return;
                }
                int resId = r.getIdentifier("parts_catalog", "xml", NGPARTS_PACKAGE);
                if (resId > 0) {
                    loadPartsFromResourceLocked(r, resId, mParts);
                }
            } catch (PackageManager.NameNotFoundException e) {
                // no ngparts installed
            }
        }
    }
        ...
        try {
            ...
            while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
                ...
                if ("part".equals(nodeName)) {
                    ...
                    sa = res.obtainAttributes(attrs, ng_Searchable);
                    info.setXmlRes(sa.getResourceId(ng_Searchable_xmlRes, 0));
