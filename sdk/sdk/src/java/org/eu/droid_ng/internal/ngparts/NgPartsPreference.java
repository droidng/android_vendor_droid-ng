...
import org.eu.droid_ng.preference.RemotePreference;
 ...
 */
public class NgPartsPreference extends RemotePreference {

    private static final String TAG = "NgPartsPreference";

    private final PartInfo mPart;

    private final Context mContext;

    public NgPartsPreference(Context context, AttributeSet attrs,
    ...
    public NgPartsPreference(Context context, AttributeSet attrs, int defStyle) {
