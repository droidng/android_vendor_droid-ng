...
public class SettingsHelper {
    ...
    private static final String NGSETTINGS_GLOBAL = NgSettings.Global.CONTENT_URI.toString();
    private static final String NGSETTINGS_SECURE = NgSettings.Secure.CONTENT_URI.toString();
    private static final String NGSETTINGS_SYSTEM = NgSettings.System.CONTENT_URI.toString();
    ...
    public String getString(Uri settingsUri) {
        ...
        } else if (uri.startsWith(NGSETTINGS_SECURE)) {
            return NgSettings.Secure.getString(resolver, uri.substring(NGSETTINGS_SECURE.length()));
        } else if (uri.startsWith(NGSETTINGS_SYSTEM)) {
            return NgSettings.System.getString(resolver, uri.substring(NGSETTINGS_SYSTEM.length()));
        } else if (uri.startsWith(NGSETTINGS_GLOBAL)) {
            return NgSettings.Global.getString(resolver, uri.substring(NGSETTINGS_GLOBAL.length()));
        }
        return null;
    }
    ...
    public int getInt(Uri settingsUri, int def) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            ...
            return NgSettings.Secure.getInt(resolver, uri.substring(NGSETTINGS_SECURE.length()), def);
        } else if (uri.startsWith(NGSETTINGS_SYSTEM)) {
            return NgSettings.System.getInt(resolver, uri.substring(NGSETTINGS_SYSTEM.length()), def);
        } else if (uri.startsWith(NGSETTINGS_GLOBAL)) {
            return NgSettings.Global.getInt(resolver, uri.substring(NGSETTINGS_GLOBAL.length()), def);
        }
        return def;
    }
    ...
    public void putString(Uri settingsUri, String value) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            ...
            NgSettings.Secure.putString(resolver, uri.substring(NGSETTINGS_SECURE.length()), value);
        } else if (uri.startsWith(NGSETTINGS_SYSTEM)) {
            NgSettings.System.putString(resolver, uri.substring(NGSETTINGS_SYSTEM.length()), value);
        } else if (uri.startsWith(NGSETTINGS_GLOBAL)) {
            NgSettings.Global.putString(resolver, uri.substring(NGSETTINGS_GLOBAL.length()), value);
        }
    }
    ...
    public void putInt(Uri settingsUri, int value) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            ...
            NgSettings.Secure.putInt(resolver, uri.substring(NGSETTINGS_SECURE.length()), value);
        } else if (uri.startsWith(NGSETTINGS_SYSTEM)) {
            NgSettings.System.putInt(resolver, uri.substring(NGSETTINGS_SYSTEM.length()), value);
        } else if (uri.startsWith(NGSETTINGS_GLOBAL)) {
            NgSettings.Global.putInt(resolver, uri.substring(NGSETTINGS_GLOBAL.length()), value);
        }
    }
