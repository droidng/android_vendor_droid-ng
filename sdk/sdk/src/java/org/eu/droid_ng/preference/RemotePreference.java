...
public class RemotePreference extends SelfRemovingPreference
    ...
    public static final String ACTION_REFRESH_PREFERENCE =
            "org.eu.droid_ng.intent.action.REFRESH_PREFERENCE";

    public static final String ACTION_UPDATE_PREFERENCE =
            "org.eu.droid_ng.intent.action.UPDATE_PREFERENCE";

    public static final String META_REMOTE_RECEIVER =
            "org.eu.droid_ng.settings.summary.receiver";

    public static final String META_REMOTE_KEY =
            "org.eu.droid_ng.settings.summary.key";

    public static final String EXTRA_ENABLED = ":ng:pref_enabled";
    public static final String EXTRA_KEY = ":ng:pref_key";
    public static final String EXTRA_SUMMARY = ":ng:pref_summary";
