 ...
 */
package org.eu.droid_ng.ngparts.search;
...
import org.eu.droid_ng.ngparts.search.Searchable.SearchIndexProvider;
import org.eu.droid_ng.internal.ngparts.PartInfo;
import org.eu.droid_ng.internal.ngparts.PartsList;
import org.eu.droid_ng.platform.internal.R;
...
import static org.eu.droid_ng.internal.ngparts.PartsList.NGPARTS_ACTIVITY;

/**
 * Provides search metadata to the Settings app
 */
public class NgPartsSearchIndexablesProvider extends SearchIndexablesProvider {

    private static final String TAG = NgPartsSearchIndexablesProvider.class.getSimpleName();
    ...
    public Cursor queryXmlResources(String[] strings) {
        ...
        for (String key : keys) {
            ...
            ref[COLUMN_INDEX_XML_RES_ICON_RESID] = R.drawable.ic_launcher_ng;
            ref[COLUMN_INDEX_XML_RES_INTENT_ACTION] = i.getAction();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = NGPARTS_ACTIVITY.getPackageName();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_CLASS] = NGPARTS_ACTIVITY.getClassName();
            cursor.addRow(ref);
        }
        return cursor;
        ...
        for (String key : keys) {
            ...
            for (SearchIndexableRaw raw : rawList) {
                ...
                ref[COLUMN_INDEX_RAW_ICON_RESID] = raw.iconResId > 0 ? raw.iconResId :
                        (i.getIconRes() > 0 ? i.getIconRes() : R.drawable.ic_launcher_ng);
                ...
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_PACKAGE] = raw.intentTargetPackage != null ?
                        raw.intentTargetPackage : NGPARTS_ACTIVITY.getPackageName();
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_CLASS] = raw.intentTargetClass != null ?
                        raw.intentTargetClass : NGPARTS_ACTIVITY.getClassName();
