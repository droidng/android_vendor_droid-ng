...
import org.eu.droid_ng.platform.internal.common.NgSystemServiceHelper;

/**
 * Base Ng System Server which handles the starting and states of various Ng
 ...
 */
public class NgSystemServer {
    private static final String TAG = "NgSystemServer";
    private Context mSystemContext;
    private NgSystemServiceHelper mSystemServiceHelper;

    private static final String ENCRYPTING_STATE = "trigger_restart_min_framework";
    private static final String ENCRYPTED_STATE = "1";

    public NgSystemServer(Context systemContext) {
        mSystemContext = systemContext;
        mSystemServiceHelper = new NgSystemServiceHelper(mSystemContext);
    }
    ...
    private void run() {
        ...
        try {
            ...
            Slog.e("System", "******************************************");
            Slog.e("System", "************ Failure starting ng system services", ex);
            throw ex;
        }
    }
    ...
    private void startServices() {
        ...
        String[] externalServices = context.getResources().getStringArray(
                org.eu.droid_ng.platform.internal.R.array.config_externalNgServices);

        for (String service : externalServices) {
            try {
                Slog.i(TAG, "Attempting to start service " + service);
                NgSystemService lineageSystemService =  mSystemServiceHelper.getServiceFor(service);
